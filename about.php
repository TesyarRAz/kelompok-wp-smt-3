...
<body class="d-flex flex-column vh-100">
  ...
  <main class="container mb-5 mt-4">
    ...
    <section class="d-flex flex-column flex-md-row justify-content-between m-auto mt-5 bg-dark p-5 text-white rounded">
      <article class="col d-flex flex-column justify-content-center mb-5">
        <p>
          Toko <b>BAJUKITA</b> merupakan salah satu contoh usaha bisnis yang berjalan dibagian pemesanan dan penjualan baju yang berlokasi di sukabumi.
          Dalam mengembangkan bisnisnya, toko <b>BAJUKITA</b> berupaya untuk memuaskan konsumen dan membuat konsumen percaya, dengan menggunakan bahan-bahan yang berkualitas baik.
        </p>
      </article>
